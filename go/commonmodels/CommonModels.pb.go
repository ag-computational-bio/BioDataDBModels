...
type User struct {
	...
	Rights   Right    `protobuf:"varint,2,opt,name=Rights,proto3,enum=Right" json:"Rights,omitempty"`
...
var file_proto_CommonModels_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x06, 0x2e, 0x52, 0x69, 0x67, 0x68, 0x74, 0x52, 0x06, 0x52, 0x69,
	...
	0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x57, 0x72, 0x69, 0x74, 0x65, 0x10, 0x01, 0x2a, 0x24, 0x0a,
	...
	0x74, 0x10, 0x01, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_proto_CommonModels_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_proto_CommonModels_proto_goTypes = []interface{}{
	...
	(Origin_OriginTypeEnum)(0), // 2: Origin.OriginTypeEnum
	(Version_VersionStage)(0),  // 3: Version.VersionStage
	(*User)(nil),               // 4: User
	(*Empty)(nil),              // 5: Empty
	...
	(*Int64Wrapper)(nil),       // 10: Int64Wrapper
	(*IDList)(nil),             // 11: IDList
}
var file_proto_CommonModels_proto_depIdxs = []int32{
	...
	2, // 3: Origin.OriginType:type_name -> Origin.OriginTypeEnum
	3, // 4: Version.Stage:type_name -> Version.VersionStage
