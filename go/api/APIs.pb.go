...
var file_proto_APIs_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x6c, 0x69, 0x6e, 0x6b, 0x73, 0x3a, 0x01, 0x2a, 0x32, 0xd1, 0x06, 0x0a, 0x0e,
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x6f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x6c, 0x69, 0x6e, 0x6b, 0x73, 0x3a, 0x01, 0x2a, 0x32,
...
var file_proto_APIs_proto_depIdxs = []int32{
	...
	6,  // 10: MetadataCompositeStore.InitMetadataDB:input_type -> InitMetadataDBRequest
	2,  // 11: MetadataCompositeStore.ListMetadataDBs:input_type -> Empty
	7,  // 12: MetadataCompositeStore.InitMetadataDBCollection:input_type -> InitMetadataCollectionRequest
	2,  // 13: MetadataCompositeStore.ListMetadataDBCollections:input_type -> Empty
	8,  // 14: MetadataCompositeStore.InsertMetadata:input_type -> InsertMetadataRequest
	9,  // 15: MetadataCompositeStore.AddMetadataIndex:input_type -> AddMetadataIndexRequest
	10, // 16: MetadataCompositeStore.Query:input_type -> QueryRequest
	11, // 17: LoadService.CreateLoadLinkSet:output_type -> UploadLinks
	12, // 18: DatasetService.CreateNewDataset:output_type -> DatasetEntry
	13, // 19: DatasetService.Datasets:output_type -> DatasetList
	2,  // 20: DatasetService.DeleteDataset:output_type -> Empty
	14, // 21: DatasetService.CreateNewDatasetVersion:output_type -> DatasetVersionEntry
	15, // 22: DatasetService.DatasetVersions:output_type -> DatasetVersionList
	2,  // 23: DatasetService.DeleteDatasetVersion:output_type -> Empty
	2,  // 24: DatasetService.UpdateDatasetVersionObjectCount:output_type -> Empty
	16, // 25: DatasetService.DatasetVersionObjects:output_type -> DatasetObjectList
	17, // 26: DatasetService.DatasetVersionObjectsLinks:output_type -> DatasetObjectLinks
	18, // 27: MetadataCompositeStore.InitMetadataDB:output_type -> MetadataDBEntry
	19, // 28: MetadataCompositeStore.ListMetadataDBs:output_type -> MetadataDBList
	18, // 29: MetadataCompositeStore.InitMetadataDBCollection:output_type -> MetadataDBEntry
	20, // 30: MetadataCompositeStore.ListMetadataDBCollections:output_type -> MetadataDBCollectionList
	2,  // 31: MetadataCompositeStore.InsertMetadata:output_type -> Empty
	2,  // 32: MetadataCompositeStore.AddMetadataIndex:output_type -> Empty
	21, // 33: MetadataCompositeStore.Query:output_type -> Field
