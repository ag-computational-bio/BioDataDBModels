...
var file_proto_APIs_proto_rawDesc = []byte{
	...
	0x73, 0x3a, 0x01, 0x2a, 0x32, 0xea, 0x02, 0x0a, 0x16, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
...
var file_proto_APIs_proto_depIdxs = []int32{
	...
	6,  // 8: MetadataCompositeStore.InsertMetadata:input_type -> InsertMetadataRequest
	7,  // 9: MetadataCompositeStore.AddMetadataIndex:input_type -> AddMetadataIndexRequest
	8,  // 10: MetadataCompositeStore.Query:input_type -> QueryRequest
	9,  // 11: LoadService.CreateLoadLinkSet:output_type -> UploadLinks
	10, // 12: DatasetService.CreateNewDataset:output_type -> DatasetEntry
	11, // 13: DatasetService.Datasets:output_type -> DatasetList
	12, // 14: DatasetService.CreateNewDatasetVersion:output_type -> DatasetVersionEntry
	13, // 15: DatasetService.DatasetVersions:output_type -> DatasetVersionList
	14, // 16: DatasetService.DatasetVersionObjects:output_type -> DatasetObjectList
	15, // 17: DatasetService.DatasetVersionObjectsLinks:output_type -> DatasetObjectLinks
	16, // 18: MetadataCompositeStore.InitMetadataDB:output_type -> MetadataDBEntry
	2,  // 19: MetadataCompositeStore.InsertMetadata:output_type -> Empty
	2,  // 20: MetadataCompositeStore.AddMetadataIndex:output_type -> Empty
	17, // 21: MetadataCompositeStore.Query:output_type -> Field
