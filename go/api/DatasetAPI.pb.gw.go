...
func request_DatasetService_UpdateDatasetVersionStatus_0(ctx context.Context, marshaler runtime.Marshaler, client DatasetServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq datasetapimodels.StatusUpdate
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateDatasetVersionStatus(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DatasetService_UpdateDatasetVersionStatus_0(ctx context.Context, marshaler runtime.Marshaler, server DatasetServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq datasetapimodels.StatusUpdate
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateDatasetVersionStatus(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDatasetServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DatasetServiceClient) error {
	...
	mux.Handle("POST", pattern_DatasetService_UpdateDatasetVersionStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DatasetService_UpdateDatasetVersionStatus_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DatasetService_UpdateDatasetVersionStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "datasetversion", "updatestatus"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_DatasetService_UpdateDatasetVersionStatus_0 = runtime.ForwardResponseMessage
