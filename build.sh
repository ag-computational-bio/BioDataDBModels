...
protoc --proto_path=. --go_out=plugins=grpc:go --go_opt=paths=source_relative proto/CommonModels.proto proto/DatasetModels.proto proto/LoadModels.proto proto/MetadataModels.proto proto/AuthModels.proto proto/APIs.proto
...
grpc_tools_ruby_protoc -I. --ruby_out=ruby --grpc_out=ruby proto/CommonModels.proto proto/DatasetModels.proto proto/LoadModels.proto proto/MetadataModels.proto proto/AuthModels.proto proto/APIs.proto
